...
export function mergeObjects(obj1, obj2) {
    ...
    const mergedObject = {
        ...obj1,
        ...Object.fromEntries(Object.entries(obj2).filter(([key]) => !obj1?.[key]))
    };
    return mergedObject;
}
export const confirmBox = (useconfirm, endpoint, options, params, successCallback, // Define the type for successCallback
errorCallback // Define the type for errorCallback
) => {
